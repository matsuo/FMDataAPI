...
/**
 * Class FileMakerRelation is the record set of queried data. This class implements the Iterator interface.
...
class FileMakerRelation implements Iterator
{
     ...
     * If the relation comes from the getRecord () method,
    ...
    /**
     * The record pointer goes back to the previous record. This does not care about the range of pointer value.
     */
    ...
    /**
     * The record pointer goes forward to the previous record. This does not care about the range of pointer value.
     */
     ...
     *
     * @return int|null The value of a special field recordId.
     */
    ...
    /**
     * Return the value of a special field modId in the current pointing record.
     *
    ...
    /**
     * Return the base64 encoded data in the container field with streaming interface. The access with
     ...
     * @param string|null $toName The table occurrence name of the portal as the prefix of the field name.
     *
     * @return string|null The base64 encoded data in the container field.
     * @throws Exception
     */
    ...
    /**
     * Checks if the current position is valid. This method is implemented for Iterator interface.
     *
